...
namespace Microsoft.NET.HostModel.Bundle
{
    ...
    public class Manifest
    {
        ...
        public Manifest(uint bundleMajorVersion)
        {
        ...
        public FileEntry AddEntry(FileType type, FileStream fileContent, string relativePath, long offset, long compressedSize)
        {
            FileEntry entry = new FileEntry(type, relativePath, offset, fileContent.Length, compressedSize);
            Files.Add(entry);
