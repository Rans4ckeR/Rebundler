...
namespace Microsoft.NET.HostModel.AppHost
{
    ...
    public static class HostWriter
    {
        ...
        /// </summary>
        private const string AppBinaryPathPlaceholder = "c3ab8ff13720e8ad9047dd39466b3c8974e592c2fa383d4a3960714caef0c4f2";//SHA256 hash of "foobar"
            ...
            string assemblyToCopyResourcesFrom = null)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    BinaryUtils.SearchAndReplace(memoryMappedViewAccessor, AppBinaryPathPlaceholderSearchValue, bytesToWrite);

                    if (windowsGraphicalUserInterface)
                    {
                        PEUtils.SetWindowsGraphicalUserInterfaceBit(memoryMappedViewAccessor);
                    }
